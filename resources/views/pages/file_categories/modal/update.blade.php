            ...
            <div class="modal-content rounded">
                <div class="modal-body scroll-y ">
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ $data->title }}" placeholder="Tuliskan Nama File Categories">
                    </div>
    ...
    $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = "{{ route('file-categories.update',':id') }}".replace(':id','{{ $data->uuid }}')
