            ...
            <div class="modal-content rounded">
                <div class="modal-body scroll-y ">
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <input type="text" class="form-control" name="sasaran" placeholder="Tuliskan Sasaran">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Indikator</label>
                        <input type="text" class="form-control" name="indikator" placeholder="Tuliskan Indikator">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Target</label>
                        <input type="number" class="form-control" name="target" placeholder="Tuliskan Target">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Tercapai</label>
                        <input type="number" class="form-control" name="tercapai" placeholder="Tuliskan Tercapai">
                    </div>


                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Persentase Capaian</label>
                        <input type="number" class="form-control" name="persentase_capaian" placeholder="Tuliskan Tercapai">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Satuan</label>
                        <input type="text" class="form-control" name="satuan" placeholder="Tuliskan Satuan">
                    </div>
    ...
    $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = '{{ route("e-performance.store") }}'
