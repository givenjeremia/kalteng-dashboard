            ...
            <div class="modal-content rounded">
                <div class="modal-body scroll-y ">
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <select name="ceiling_id" class="form-control form-select">
                            ...
                            @foreach ($ceilings as $item)
                                <option value="{{ $item->pkid }}">Rp. {{ number_format($item->nominal , 0, ',', '.')  }} - {{ $item->departement->title }} - {{ $item->tahun }} - {{ $item->type_data }}</option>
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <input type="number" class="form-control" name="realisasi_pegawai" placeholder="Tuliskan Nominal">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Realization Of Goods</label>
                        <input type="number" class="form-control" name="realisasi_barang" placeholder="Tuliskan Nominal">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Realization Of Capital</label>
                        <input type="number" class="form-control" name="realisasi_modal" placeholder="Tuliskan Nominal">
                    </div>
