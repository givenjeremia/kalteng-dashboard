            ...
            <div class="modal-content rounded">
                <div class="modal-body scroll-y ">
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <input type="number" class="form-control" name="anggaran" placeholder="Tuliskan Anggaran">
                    </div>
                    ...
                    <div class="fv-row mt-3">
                        ...
                        <input type="text" class="form-control" name="keterangan" placeholder="Tuliskan Keterangan">
                    </div>
