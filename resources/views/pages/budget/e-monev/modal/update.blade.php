        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded">
                <div class="modal-body scroll-y ">
                    ...
                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Anggaran</label>
                        <input type="number" class="form-control" name="anggaran"  value="{{ $data->anggaran }}"  placeholder="Tuliskan Anggaran">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Status Pelaksanaan</label>
                        <input type="number" class="form-control" name="kinerja_satker"  value="{{ $data->kinerja_satker }}"  placeholder="Tuliskan Anggaran">
                    </div>

                    <div class="fv-row mt-3">
                        <label for="required" class="required fs-6 fw-semibold mb-2">Keterangan</label>
                        <input type="text" class="form-control" name="keterangan" value="{{ $data->keterangan }}"  placeholder="Tuliskan Keterangan">
                    </div>
    ...
    $('#btn-simpan').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let act = "{{ route('e-monev.update',':id') }}".replace(':id','{{ $data->uuid }}')
